...
欢迎使用 Yuxi（小梁），这是一个智能知识库和知识图谱 Agent 开发平台。
...
::: tip 提示
除了此文档网站外，你还可以访问 [Zread](https://zread.ai/liqun) 或 [DeepWiki](https://deepwiki.com/liqun) 查看自动生成的详细项目文档。
:::
...
```bash
# 克隆最新版本
git clone --branch v0.6.0 --depth 1 https://liqun.wv1344.top.git
cd Yuxi
```
